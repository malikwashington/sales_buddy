...
with server.app.app_context():
    ...
    for contact in contact_data:
        ...
        for i, record in enumerate(contact['call_history']):
            ...
            r = record['call_time']
            test_contact.last_contacted = r if r > str(test_contact.last_contacted) else test_contact.last_contacted
            ...
            test_contact = seed_funcs.add_call_to_contact(
                test_contact, record['call_time'])
        ...
        for i, record in enumerate(contact['text_history']):
            ...
            test_contact = seed_funcs.add_text_to_contact(
        ...
        for i, record in enumerate(contact['email_history']):
            ...
            test_contact = seed_funcs.add_email_to_contact(
